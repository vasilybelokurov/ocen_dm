...
\item \emph{Simulation:} a simplified late Omega Centauri--Milky Way encounter of a tidally stripped host that reproduces the present configuration, to see whether dark matter survives (Sections~\ref{sec:budget} and the companion note).
\end{enumerate}
